      ...
      <div id="wrapper">
        <div id="main_content">
            ...
            <hr>
             ...
             <br><br>
        <form action="search_db_employee.php" method="post">
        ...
        if(isset($_POST['submit'])){
            $name=$_POST['search'];
            $sql="SELECT EmployeeID, FirstName, LastName, PhoneNumber, Address FROM employee WHERE  FirstName LIKE '%" . $name . "%' OR EmployeeID LIKE '%" . $name  ."%'";// 
        ...
        if ($result->num_rows > 0) {
            echo "<table><tr><th>Employee ID</th><th>Name</th><th>Phone</th><th>Address</th></tr>";
            // output data of each row
            while($row = $result->fetch_assoc()) {
                echo "<tr><td>".$row["EmployeeID"]."</td><td>".$row["FirstName"]." ".$row["LastName"]."</td><td>".$row["PhoneNumber"]."</td><td>".$row["Address"]."</td></tr>";
            }
            echo "</table>";
        } 
        }
