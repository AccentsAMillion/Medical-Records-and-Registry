<!DOCTYPE html>
   ...
   <script src="script.js"></script>
      ...
      <div id="wrapper">
        <div id="main_content">
           ...
           <nav>
            ...
            <form action="insert_new_hire_employee_form.php" method="post"><!--or get-->
    ...
    if(isset($_POST['submit'])){
       ...
       $sqlInsertTable = "INSERT INTO employee (EmployeeID, HireDate, FirstName, LastName, PhoneNumber, Address)
       VALUES('$_POST[employee_id]','$_POST[hire_date]','$_POST[first_name]','$_POST[last_name]','$_POST[phone_number]','$_POST[address]')";
