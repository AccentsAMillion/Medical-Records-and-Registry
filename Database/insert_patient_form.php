<!DOCTYPE html>
   ...
   <script src="script.js"></script>
    ...
    <body>
      ...
      <div id="wrapper">
        <div id="main_content">
            ...
            <form action="insert_patient_form.php" method="post"><!--or get-->
            First Name: <input type="text" name="first_name"><br><br>
            Last Name: <input type="text" name="last_name"><br><br>
            Phone Number: <input type="tel" name="phone_number"><br><br>
            Patient Address: <input type="text" name="address"><br><br>
    ...
    if(isset($_POST['submit'])){
       ...
       $sqlInsertTable = "INSERT INTO patient (FirstName, LastName, PhoneNumber, Address)
