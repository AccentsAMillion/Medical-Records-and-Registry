      ...
      <div id="wrapper">
        <div id="main_content">
            ...
            <hr>
             ...
             <br><br>
        <form action="search_db_doctor.php" method="post">
        ...
        if(isset($_POST['submit'])){
            $name=$_POST['search'];
            $sql="SELECT DoctorID, FirstName, LastName, PhoneNumber, Address FROM doctor WHERE  FirstName LIKE '%" . $name . "%' OR DoctorID LIKE '%" . $name  ."%'";// 
        ...
        if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                echo "<tr><td>".$row["DoctorID"]."</td><td>".$row["FirstName"]." ".$row["LastName"]."</td><td>".$row["PhoneNumber"]."</td><td>".$row["Address"]."</td></tr>";
            }
            echo "</table>";
        } 
        }
