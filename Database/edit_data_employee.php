      ...
      <div id="wrapper">
        <div id="main_content">
            ...
            <hr>
             <div id="wrapper3">
             <section>
             <legend>Manage Employee Information</legend>
             <br><br>
        <?php
        ...
        if (!$conn) {
            ...
            if(isset($_POST['update'])){
                $UpdateQuery = "UPDATE employee SET EmployeeID='$_POST[employeeid]',
                FirstName='$_POST[firstname]',
                LastName='$_POST[lastname]',
                PhoneNumber='$_POST[phonenumber]',
                Address='$_POST[address]' WHERE EmployeeID='$_POST[hidden]'";
                mysqli_query($conn, $UpdateQuery);
            }
            
            if(isset($_POST['delete'])){
                $DeleteQuery = "DELETE FROM employee WHERE EmployeeID='$_POST[employeeid]' LIMIT 1";
                mysqli_query($conn, $DeleteQuery);
            }
            
             if(isset($_POST['insert'])){
                $AddQuery = "INSERT INTO Employee (EmployeeID, FirstName, LastName, PhoneNumber, Address)
                VALUES('$_POST[addemployeeid]',
                '$_POST[addfirstname]',
                '$_POST[addlastname]',
        ...
        if ($result->num_rows > 0) {
            echo "<table><tr><th>Employee ID</th><th>First Name</th><th>Last Name</th><th>Phone Number</th><th>Address</th></tr>";
            while($row = $result->fetch_assoc()) {
                echo "<form action=edit_data_employee.php method=post>";
                echo "<tr>";
                    ...
                    echo "<td>" . "<input type=hidden name=hidden value='" . $row["EmployeeID"] . "'> </td>";
            ...
            echo "<form action=edit_data_employee.php method=post>";
            echo "<tr>";
            echo "<td><input type=text name=addemployeeid> </td>";
