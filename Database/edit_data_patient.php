      ...
      <div id="wrapper">
        <div id="main_content">
            ...
            <hr>
             <div id="wrapper3">
             <section>
             <legend>Manage Patient Information</legend>
             <br><br>
        <?php
        ...
        if (!$conn) {
            ...
            if(isset($_POST['update'])){
                $UpdateQuery = "UPDATE patient SET PatientID='$_POST[patientid]',
                FirstName='$_POST[firstname]',
                LastName='$_POST[lastname]',
                PhoneNumber='$_POST[phonenumber]',
                Address='$_POST[address]' WHERE PatientID='$_POST[hidden]'";
                mysqli_query($conn, $UpdateQuery);
            }
            
            if(isset($_POST['delete'])){
                $DeleteQuery = "DELETE FROM patient WHERE PatientID='$_POST[patientid]' LIMIT 1";
                mysqli_query($conn, $DeleteQuery);
            }
            
             if(isset($_POST['insert'])){
                $AddQuery = "INSERT INTO patient (PatientID, FirstName, LastName, PhoneNumber, Address)
        ...
        if ($result->num_rows > 0) {
            echo "<table><tr><th>Patient ID</th><th>First Name</th><th>Last Name</th><th>Phone Number</th><th>Address</th></tr>";
            while($row = $result->fetch_assoc()) {
                echo "<form action=edit_data_patient.php method=post>";
                echo "<tr>";
                    ...
                    echo "<td>" . "<input type=hidden name=hidden value='" . $row["PatientID"] . "'> </td>";
        ...
        ?>  
             ...
             <hr>
                ...
                <li class='has-sub'><a href='#'><span>Patient Database</span></a>
                    <ul>
                        <li><span><a href='#'><span>Edit</span></a></li>
                ...
                <li class='has-sub'><a href='#'><span>Search Database</span></a>
                    <ul>
                        ...
                        <li><a href='search.db_patient.php'><span>Patients</span></a></li>
